...
- Name: auth.spec.ts >> Authentication & SaaS Routing Flow >> Login failure displays graceful error message
...
Locator: locator('[data-testid="auth-error-banner"]')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('[data-testid="auth-error-banner"]') with timeout 10000ms
  - waiting for locator('[data-testid="auth-error-banner"]')
